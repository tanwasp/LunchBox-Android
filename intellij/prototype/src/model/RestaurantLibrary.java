...
//            Collections.sort(matches, Comparator.comparingDouble(r -> (double) r.haversine(r.lat, r.lon, user.lat, user.lon)));
    ...
    public Review postReview(User user, Restaurant restaurant, float rating, String reviewText) {
     ...
     public void loadRestaurants() {
        ...
        Restaurant r2 = new Restaurant("restaurant2", "Britt’s Bakehouse", 5.0f, "137 W Jefferson Ave", "Kirkwood", "MO", "US", "63122", 38.5825641f, -90.4079162f, new ArrayList<>(Arrays.asList("review11", "review30", "review32", "review52", "review58")), 1);
        this.data.put("restaurant2", r2);

        Restaurant r3 = new Restaurant("restaurant3", "Maple Creek Country Club", 4.5f, "10501 E 21st St", "Indianapolis", "IN", "US", "46229", 39.7963819f, -85.9817333f, new ArrayList<>(Arrays.asList("review7", "review35", "review40", "review46")), 1);
        this.data.put("restaurant3", r3);

        Restaurant r4 = new Restaurant("restaurant4", "McDonald's", 1.0f, "709 Terry Pkwy", "Gretna", "LA", "US", "70056", 29.8998883024f, -90.0298833754f, new ArrayList<>(Arrays.asList("review12", "review23", "review25", "review41")), 1);
        this.data.put("restaurant4", r4);

        Restaurant r5 = new Restaurant("restaurant5", "Little Greek Restaurant", 4.0f, "19022 Bruce B Downs Blvd", "Tampa", "FL", "US", "33647", 28.1445589708f, -82.3546334163f, new ArrayList<>(Arrays.asList("review20", "review24", "review29", "review33")), 1);
        this.data.put("restaurant5", r5);

        Restaurant r13 = new Restaurant("restaurant13", "Biscuit Love: Hillsboro Village", 4.0f, "2001 Belcourt Ave", "Nashville", "TN", "US", "37212", 36.1367494339f, -86.7997314667f, new ArrayList<>(Arrays.asList("review10", "review43", "review61")), 2);
        ...
        Restaurant r15 = new Restaurant("restaurant15", "Hot Dogs on Main", 4.5f, "505 Main St", "Dunedin", "FL", "US", "34698", 28.0124356f, -82.7855034f, new ArrayList<>(Arrays.asList("review14", "review47", "review60")), 3);
        this.data.put("restaurant15", r15);

        Restaurant r14 = new Restaurant("restaurant14", "Truckee Bagel Company - Midtown", 3.5f, "538 S Virginia St, Ste B", "Reno", "NV", "US", "89501", 39.5202401f, -119.810022f, new ArrayList<>(Arrays.asList("review13", "review54", "review65")), 3);
        this.data.put("restaurant14", r14);

        Restaurant r11 = new Restaurant("restaurant11", "Hunters Station", 4.5f, "975 Main St", "Nashville", "TN", "US", "37206", 36.1782943f, -86.7522834f, new ArrayList<>(Arrays.asList("review8", "review34", "review56")), 2);
        ...
        Restaurant r8 = new Restaurant("restaurant8", "Cafe Rista", 4.0f, "14213 103 Ave NW", "Edmonton", "AB", "US", "T5N 0S8", 53.5438013f, -113.5666839f, new ArrayList<>(Arrays.asList("review4", "review38", "review39")), 3);
